...
import {JsonDatabasePathStore} from "./main/adapters/outbound/settings/JsonDatabasePathStore.js";
...
app.whenReady().then(async () => {
  ...
  const databasePathStore = new JsonDatabasePathStore(settingsFilePath, defaultDatabasePath);
